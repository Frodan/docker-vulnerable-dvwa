    ...
    stage('DAST') {
      ...
      sh '''
        ...
        docker run \
            ...
            bin/arachni http://project.local  --plugin=autologin:url=http://project.local:9000/login.php,parameters="username=admin&password=password&Login=Login&user_token=fbd9ba9b1d25da438853d66e3e34b065",check="logout.php" --scope-exclude-pattern=Logout --report-save-path=reports/project.local.afr;
